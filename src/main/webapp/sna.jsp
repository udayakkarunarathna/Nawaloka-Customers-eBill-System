...
<%
String title = "e-Bill";
String tmp_title = "SERVICE NON APPOINTMENT RECEIPT";
			%>
...
<body style="padding: 8px">
    ...
    try {
        ...
        ResultSet rs3 = null;
        String nawasn = "NAWALOKA HOSPITALS PLC";
        String newnawasn = "NEW NAWALOKA HOSPITALS (PVT) LTD";
        String nnmcsn = "NEW NAWALOKA MEDICAL CENTER (PVT) LTD";
        String tes3 = " " +
                "SELECT SN.NAME_BHT, " +
                "       NVL(SN.TELE, '-') TELE, " +
                "       SN.AGE_YY, " +
                ...
                "     DOCTORS@COLOMBO_LIVE d " +
                " " +
                "WHERE NC.STATUS = 1 AND SN.STATUS = 1 AND SN.SERVICE_REF_NO = '" + refno + "' AND SN.UPIN = '" + upin + "' " +
...
%>
		...
		<jsp:include page="billheader.jsp">
			...
			<jsp:param name="ACC_ID_h" value="<%=ACC_ID%>" />
		</jsp:include>
		...
		<table class="table-sm" border="0" width="99%" align="center"
			...
			<tr>
				<td valign="top" colspan="3"><b>- Services/Payment Details
						-</b></td>
			</tr>
			<tr>
				<td><u>#</u></td>
			...
			<tr>
				<td valign="top" colspan="2" align="right">GROSS AMOUNT
					(Rs.):&nbsp;</td>
				<td valign="top" align="right" style="border-top: 1px solid black;"><b><%=df.format(TOTAL)%></b></td>
			</tr>
			<tr>
		...
		<table class="table-sm" border="0" width="99%" align="center"
			...
			<tr>
				<td valign="top" style="white-space: nowrap;">Bank/Branch Name</td>
				<td valign="top">:</td>
				<td valign="top"><%=cBank%></td>
			</tr>
			<tr>
				<td valign="top" style="white-space: nowrap;">Authorized Person</td>
				<td valign="top">:</td>
				<td valign="top"><%=cAuth%></td>
			</tr>
			<%}%>
			<tr><td height="2pt"></td></tr>
			<tr>
				<td valign="top" style="white-space: nowrap;">Issued User</td>
				<td valign="top">:</td>
			...
			<td align="left" colspan="3"><div align="left">
				...
				<td align="center" colspan="1"><div align="center">
						<jsp:include page="qrcodegen.jsp">
							...
							<jsp:param name="this_page" value="sna" />
						</jsp:include>
					</div></td>
			</tr>
		</table>
