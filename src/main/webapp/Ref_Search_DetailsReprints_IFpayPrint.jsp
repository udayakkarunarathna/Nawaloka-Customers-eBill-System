...
String NAME = "", DOB = "", BHT = "", YY = "", MM = "", cBank = "", ccRcpNo = "", cNo = "", cAuth = "", UPIN = "",
		DATE = "", RCPT_NO = "", REF_NO = "", DESCRIPTION = "", REMARKS = "", CASHIER_ID = "", DIS_REASON = "",
		ONLINE_INVO = "", mode = "";
...
try {
	...
	+ "       CC.ACC_ID                                                                                    as acc,\n"
	+ "       DECODE(ep.PAYMENT_TYPE,1,'INITIAL',2,'FURTHER',3,'FINAL') as Stat\n"
			...
			<td>
				...
				<table width="265px">
					...
					<tr>
						...
						<td align="right" valign="top"><%=df.format(TOTAL)%></td>
					</tr>
				</table>
						...
						<td colspan="2">
							<table>
								...
								<table>
									...
									%>
									<tr>
										<td colspan="2" height="5pt"></td>
									</tr>
									<tr>
										<td colspan="2">REMARKS : <%=REMARKS%>
										</td>
									</tr>
									<%
									}
